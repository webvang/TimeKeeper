...
$listcontent = $_SESSION['listcontent'] = $_GET['listcontent'];
...
$sql = "UPDATE todolist SET itemindex = '$listIndex' ,  itemdone = 'true' WHERE username = '$username' AND itemindex = '$listIndex' ";
